...
public class EasyActivity extends BaseActivity {
	...
	private void initView() {
		...
		myAdapter = new MyAdapter<TicketModel>(context, showList,
			...
			public void convert(ViewHolder viewHolder, final TicketModel model) {
				...
				viewHolder.setText(R.id.tv_item_price, model.getLow_price()
						+ " - " + model.getHighest_price());
				viewHolder
						.setText(R.id.tv_item_num, model.getFreecount() + "张");
				viewHolder.setImageResource(R.id.iv_item_poster,
						R.drawable.discover_default);
				viewHolder.getConvertView().setOnClickListener(
						new OnClickListener() {
							@Override
							public void onClick(View arg0) {
								UiUtils.showToast(context,
										model.getTicketname() + "onclick");
							}
						});
			}
		};
